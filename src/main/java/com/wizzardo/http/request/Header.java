...
public enum Header {
    ...
    KEY_ACCESS_CONTROL_ALLOW_CREDENTIALS("Access-Control-Allow-Credentials"),
    KEY_ACCESS_CONTROL_ALLOW_HEADERS("Access-Control-Allow-Headers"),
    KEY_ACCESS_CONTROL_ALLOW_ORIGIN("Access-Control-Allow-Origin"),
    KEY_ACCESS_CONTROL_MAX_AGE("Access-Control-Max-Age"),
    KEY_ACCESS_CONTROL_REQUEST_HEADERS("Access-Control-Request-Headers"),
